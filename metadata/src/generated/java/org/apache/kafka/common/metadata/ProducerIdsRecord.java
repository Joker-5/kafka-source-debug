...
public class ProducerIdsRecord implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("producer_ids_end", Type.INT64, "The highest producer ID that has been generated"),
    ...
    public void read(Readable _readable, short _version) {
        ...
        this.producerIdsEnd = _readable.readLong();
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        _writable.writeLong(producerIdsEnd);
    ...
    public boolean equals(Object obj) {
        ...
        if (producerIdsEnd != other.producerIdsEnd) return false;
    ...
    public int hashCode() {
        ...
        hashCode = 31 * hashCode + ((int) (producerIdsEnd >> 32) ^ (int) producerIdsEnd);
        return hashCode;
    }
    ...
    public ProducerIdsRecord duplicate() {
        ...
        _duplicate.producerIdsEnd = producerIdsEnd;
        return _duplicate;
    }
    ...
    public long producerIdsEnd() {
        return this.producerIdsEnd;
    }
    ...
    public ProducerIdsRecord setProducerIdsEnd(long v) {
        this.producerIdsEnd = v;
        return this;
    }
}
